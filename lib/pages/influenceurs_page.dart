...
import 'package:peemart/pages/comment_page.dart';
import 'package:peemart/pages/influencer_page.dart';
import 'package:peemart/pages/product_detail_page.dart';
import 'package:peemart/services/post_service.dart';
import 'package:peemart/services/product_service.dart';
import 'package:peemart/widgets/gallery_page.dart';
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final images = postImages.isNotEmpty
                    ? postImages
  ...
  Widget buildImages(List images) {
    ...
    if (images.length == 1) {
      return GestureDetector(
        ...
        child:
            buildPostImage(getImageUrl(images[0]['image_url'])),
      );
    }
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          ...
          child: Stack(
            children: [
              buildPostImage(
                  getImageUrl(images[index]['image_url'])),
